...
public class ReservationService {
    ...
    public Reservation createReservation(LocalDateTime reservationTime,
        ...
        Reservation reservation = new Reservation(reservationTime, reservationEndTime, status, mechanicNeed, price, station, vehicle, mechanic);
    ...
    public Reservation updateReservation(Integer reservationId,
        ...
        existingReservation.setReservation_time(reservationTime);
        existingReservation.setReservation_end_time(reservationEndTime);
        existingReservation.setStatus(status);
        existingReservation.setMechanic_need(mechanicNeed);
